          ...
          <form method="post" id="ajexForm" onsubmit="return validateDateTime()" action="{{ route('class.store') }}" autocomplete="off" class="form-horizontal" >
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <input type="checkbox" name="sell_each_session" value="1">
                 ...
                 <div class="row">
                    ...
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input  id="end_date_time" class="form-control" value="{{ old('batch_end_date')}}" name="batch_end_date" placeholder="Enter End Date & Time">
                        {{-- <input type="date" id="class_date_time" class="form-control" value="{{ old('batch_end_date')}}"name="batch_end_date" placeholder="Enter End Date & Time"> --}}
              ...
              {{-- /card code for add session --}}
               <div class="card-footer ml-auto mr-auto">
                @include('_form.button',['id'=>'saveForm', 'title'=>'Save Classes'])
              </div>
