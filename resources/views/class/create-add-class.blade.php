       ...
       <div>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <div class="">
            <input id="batch_price_per_session" name="batch_price_per_session" type="text" placeholder="&pound; Enter Class Price Per Session" class="form-control input-md middel_width">
        ...
        <div class="col-md-3">
         ...
         <div class="form-group">
            ...
            <p style="color: gray; font-size:10px;"><i>End date will be filled automatically,based on session's dat</i></p>
         </div> 
