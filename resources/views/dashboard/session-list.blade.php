            ...
            <div class="card shadow mb-4">
                <div class="card-body p-0">
                    <div class="tab-content" id="myTabContent">
                                                ...
                                                <div class="d-flex justify-content-around">
                                                    ...
                                                    <div>
                                                        ...
                                                        {{-- <a href="{{ $batch->zoom->meeting_join_url ?? ''  }}"> --}}
                                                            <a style="text-decoration:none; font-size:15px; color: #0EA47E;" href="{{ url('zoom', $batch->id)  }}">join now</a></p>
                                                           {{-- <i> <a style="text-decoration:none; font-size:15px; color: #0EA47E;" href="{{ url('zoom', $batch->id)  }}" class="fa fa-search-plus" aria-hidden="true"></a></i> --}}


                                                            {{-- <a href="{{ url('zoom', $batch->id)  }}">join now</a> --}}
                                                            {{-- <a button type="button" class="btn btn-primary btn-sm">join now</a></button> --}}
                        ...
                        {{-- pagination --}}
                        {{-- <ul style="margin:30px;" class="pagination">
