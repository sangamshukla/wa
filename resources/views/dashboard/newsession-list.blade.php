                            ...
                            <div class="mt-3 mb-3 tab-card">
                                <div class="tab-card-header">
                                  <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link tab_cta active" id="one-tab" data-toggle="tab" href="#one" role="tab" aria-controls="One" aria-selected="true">Today</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade p-3" id="three" role="tabpanel" aria-labelledby="three-tab">
                                            <div id="accordion">
                                                ...
                                                @foreach ($session->ordered_session as $session)
                                                <div class="card mb-3">
                                                    @php
                                                            $id=uniqid();
                                                        @endphp
                                                  <div class="card-header" id="headingOne{{$id}}">
                                                    <h5 class="mb-0">
                                                        ...
                                                        <div>
                                                            <p class="subject_card">Subject</p>
                                                            <p class="card_subject_title1">{{$session->batch->subject->name}}</p>
                                                        </div>
                                                        {{-- <div class="border-left first_left_border"></div>
                                                        <div>
                                                            <p class="subject_card">Session</p>
                                                        ...
                                                        <div class="border-left second_left_border"></div>
                                                        <div>
                                                            <p class="subject_card">
                                                                Join Now
                                                            </p>
                                                            <p class="card_subject_title3">
                                                                 <a style="text-decoration:none;" href="#">
                                                                    Join now
                                                                </a>
                                                            </p>
                                                        </div>
                                                        <button class="btn btn-link card_cta" data-toggle="collapse" data-target="#collapseOne{{$id}}" aria-expanded="true" aria-controls="collapseOne">
                                                             <img src="{{asset('wa/dashboard/sessionlist/img/chevron.svg')}}" alt="arrow" title="arrow">
                                                         </button>
                                                    </div>
                                                    <p class="date_text">
                                                        Feb 04, 2021 - Feb 21,2021
                                                    </p>
                                                    </h5>
                                                  </div>
'''''''''''''''''''
