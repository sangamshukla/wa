                ...
                <div class="align-items-center d-flex h-100">
                    <div class="card-body">
                        ...
                        <footer class="footer footer-alt">
                            <p class="text-muted">Don't have an account? <a href="{{ url('student-register') }}" class="text-muted ml-1"><b>Register</b></a></p>
        ...
        @endif
            ...
            <div class="auth-fluid-right text-center">
                <div class="auth-user-testimonial">
                    <h2 class="mb-3">wallington Academy</h2>
                    <p class="lead"><i class="mdi mdi-format-quote-open"></i> wallingtonacademy.co.uk <i class="mdi mdi-format-quote-close"></i>
                    </p>
                    <p>
                        - For Student
                    </p>
